...
namespace ts {
    export var Diagnostics = {
        ...
        Translate_to_RefScript_JSON_format: { code: 10000, category: DiagnosticCategory.Message, key: "Translate to RefScript (JSON format)" },
        Ambient_variable_declarator_for_0_needs_to_have_at_least_one_type_annotation: { code: 10001, category: DiagnosticCategory.Error, key: "Ambient variable declarator for '{0}' needs to have at least one type annotation." },
        Variable_declarator_for_0_needs_to_have_at_most_one_type_annotation: { code: 10002, category: DiagnosticCategory.Error, key: "Variable declarator for '{0}' needs to have at most one type annotation." },
        Class_0_has_multiple_class_annoatations: { code: 10003, category: DiagnosticCategory.Error, key: "Class '{0}' has multiple class annoatations." },
        Interface_0_has_multiple_interface_annoatations: { code: 10004, category: DiagnosticCategory.Error, key: "Interface '{0}' has multiple interface annoatations." },
        Function_0_can_have_at_most_one_type_annotation: { code: 10005, category: DiagnosticCategory.Error, key: "Function '{0}' can have at most one type annotation." },
        Variable_declarations_are_only_supported_in_the_first_part_of_the_loop_in_0: { code: 10006, category: DiagnosticCategory.Error, key: "Variable declarations are only supported in the first part of the loop in '{0}'." },
        Variable_annotation_binder_for_0_does_not_correspond_to_any_nearby_variable_declaration: { code: 10007, category: DiagnosticCategory.Error, key: "Variable annotation binder for '{0}' does not correspond to any nearby variable declaration." },
        Duplicate_type_annotation_for_variable_s_Colon_0: { code: 10008, category: DiagnosticCategory.Error, key: "Duplicate type annotation for variable(s): '{0}'" },
        Invalid_RefScript_annotation_0_Perhaps_you_need_to_replace_Colon_with_Colon_Colon: { code: 10009, category: DiagnosticCategory.Error, key: "Invalid RefScript annotation '{0}'. Perhaps you need to replace ':' with '::'." },
        Fields_should_have_at_least_one_declaration: { code: 10010, category: DiagnosticCategory.Error, key: "Fields should have at least one declaration." },
        For_in_Colon_only_non_ambient_variable_declarators_are_allowed_here: { code: 10011, category: DiagnosticCategory.Error, key: "For-in: only non-ambient variable declarators are allowed here." },
        All_variable_declarators_need_to_be_translated_to_either_RsVarDecls_or_RsEmptyStmts: { code: 10012, category: DiagnosticCategory.Bug, key: "All variable declarators need to be translated to either RsVarDecls or RsEmptyStmts" },
        BinaryExpression_toRsLValue: { code: 10013, category: DiagnosticCategory.Unimplemented, key: "BinaryExpression toRsLValue" },
        InterfaceDeclaration_member: { code: 10014, category: DiagnosticCategory.Unimplemented, key: "InterfaceDeclaration member" },
        HeritageClauses_to_RefScript: { code: 10015, category: DiagnosticCategory.Unimplemented, key: "HeritageClauses to RefScript" },
        ForInStatementSyntax_to_RsStatement: { code: 10016, category: DiagnosticCategory.Unimplemented, key: "ForInStatementSyntax to RsStatement" },
        Cannot_translate_type_0_into_RefScript_type: { code: 10017, category: DiagnosticCategory.Unimplemented, key: "Cannot translate type '{0}' into RefScript type." },
        Anonymous_function_should_have_exactly_one_type_annotation: { code: 10018, category: DiagnosticCategory.Error, key: "Anonymous function should have exactly one type annotation." },
        Import_library_only_enabled_with_refscript: { code: 10019, category: DiagnosticCategory.Message, key: "Import library (only enabled with 'refscript')." },
        Constructors_should_have_at_most_one_annotation: { code: 10020, category: DiagnosticCategory.Unimplemented, key: "Constructors should have at most one annotation." },
        Methods_should_have_exactly_one_annotation: { code: 10021, category: DiagnosticCategory.Unimplemented, key: "Methods should have exactly one annotation." },
        Cannot_call_toRsExp_on_a_UnaryExpression_with_SyntaxKind_0: { code: 10022, category: DiagnosticCategory.Unimplemented, key: "Cannot call 'toRsExp' on a UnaryExpression with SyntaxKind {0}." },
        Cannot_call_toRsLValue_on_BinaryExpression: { code: 10023, category: DiagnosticCategory.Unimplemented, key: "Cannot call 'toRsLValue' on BinaryExpression." },
        Cannot_call_toRsExp_on_BinaryExpression: { code: 10024, category: DiagnosticCategory.Unimplemented, key: "Cannot call 'toRsExp' on BinaryExpression." },
        Cannot_call_toRsExp_on_PostfixUnaryExpression_with_SyntaxKind_0: { code: 10025, category: DiagnosticCategory.Unimplemented, key: "Cannot call 'toRsExp' on PostfixUnaryExpression with SyntaxKind {0}." },
        Cannot_call_toRsAST_on_MemberAccessExpression: { code: 10026, category: DiagnosticCategory.Unimplemented, key: "Cannot call 'toRsAST' on MemberAccessExpression." },
        Cannot_call_toRsExp_on_BinaryExpression_with_SyntaxKind_0: { code: 10027, category: DiagnosticCategory.Unimplemented, key: "Cannot call 'toRsExp' on BinaryExpression with SyntaxKind {0}." },
        Gather_statistics_about_initialization: { code: 10028, category: DiagnosticCategory.Message, key: "Gather statistics about initialization" },
        Invalid_reference_of_this_in_constructor: { code: 10029, category: DiagnosticCategory.Error, key: "Invalid reference of 'this' in constructor." },
        No_support_for_value_assigned_enumeration_element_0: { code: 10030, category: DiagnosticCategory.Unimplemented, key: "No support for value assigned enumeration element '{0}'." },
        Initialization_of_parameter_0_at_the_signature_site_is_not_supported: { code: 10031, category: DiagnosticCategory.Unimplemented, key: "Initialization of parameter '{0}' at the signature site is not supported." },
        Cannot_infer_mutability_parameter_for_class_constructor: { code: 10032, category: DiagnosticCategory.Unimplemented, key: "Cannot infer mutability parameter for class constructor." },
        Class_0_needs_to_have_an_explicit_constructor: { code: 10033, category: DiagnosticCategory.Unimplemented, key: "Class '{0}' needs to have an explicit constructor." },
        Class_0_extends_other_classes_so_needs_to_have_an_explicit_constructor: { code: 10034, category: DiagnosticCategory.Unimplemented, key: "Class '{0}' extends other classes so needs to have an explicit constructor." },
        ...
        refscript_Qualfied_module_name_0_is_not_supported: { code: 10041, category: DiagnosticCategory.Unimplemented, key: "[refscript] Qualfied module name '{0}' is not supported." },
